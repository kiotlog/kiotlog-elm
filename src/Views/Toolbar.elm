...
import Html.Attributes as HtmlAttrs exposing (attribute, id, class, type_)
import Html.Events exposing (onClick)
import Svg exposing (svg, path)
import Svg.Attributes as SvgAttrs exposing (width, height, x, y, viewBox, d, fill, class)
...
view model =
    header
        ...
        , HtmlAttrs.class "mdc-top-app-bar mdc-top-app-bar--fixed"
        ]
        [ div [ HtmlAttrs.class "mdc-top-app-bar__row" ]
            [ section [ HtmlAttrs.class "mdc-top-app-bar__section mdc-top-app-bar__section--align-start" ]
                [ button
                    [ type_ "button"
                    , onClick OpenDrawer
                    , id "kiotlog-actions-button"
                    , HtmlAttrs.class "material-icons mdc-top-app-bar__navigation-icon"
                    ]
                    [ text "menu" ]
                , svg
                    [ SvgAttrs.class "kiotlog-logo"
                    , x "0px"
                    , y "0px"
                    , viewBox "0 0 100 100"
                    , attribute "enable-background" "new 0 0 100 100"
